...
export const ColorSchemeContext = createContext(/* rosePineColors.dark */ catppuccinColors.dark);
export function ColorSchemeProvider({ children }: { children: ReactNode }) {
    const { darkMode } = useContext(DarkModeContext);
    // const colorScheme = useMemo(() => (darkMode ? rosePineColors.dark : rosePineColors.light), [darkMode]);
